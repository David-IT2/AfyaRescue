...
<div class="mx-auto max-w-2xl">
    <h1 class="mb-6 text-2xl font-extrabold text-white">Request Emergency Assistance</h1>
        ...
        <div class="space-y-4">
            <div class="flex items-center justify-between rounded-md border border-slate-200 p-3">
                ...
                <select id="triage_conscious" name="triage[conscious]"
                    class="rounded-md border border-slate-300 px-2 py-1 text-sm text-slate-900 focus:border-red-500 focus:ring-red-500"
                >
            ...
            <div class="flex items-center justify-between rounded-md border border-slate-200 p-3">
                ...
                <input id="triage_number_of_casualties" type="number" name="triage[number_of_casualties]" min="0" max="20" value="{{ old('triage.number_of_casualties', 1) }}"
                    class="w-20 rounded-md border border-slate-300 px-2 py-1 text-sm text-slate-900 focus:border-red-500 focus:ring-red-500"
                />
            </div>
        </div>
